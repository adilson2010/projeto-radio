        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/rasreggaeradio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300 transition-colors w-8 h-8 flex items-center justify-center">
                <i className="ri-facebook-fill text-xl"></i>
              </a>
              <a href="https://www.instagram.com/rasreggaeradio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300 transition-colors w-8 h-8 flex items-center justify-center">
                <i className="ri-instagram-line text-xl"></i>
              </a>
              <a href="https://www.youtube.com/rasreggaeradio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-yellow-300 transition-colors w-8 h-8 flex items-center justify-center">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <div className="flex items-center space-x-2">
                ...
                <span>noresp@radiorasreggae.com.br</span>
              </div>
              <div className="flex items-center space-x-2">
